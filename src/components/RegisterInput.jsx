...
function RegisterInput({
  ...
  return (
    <div className="bg-white rounded-xl md:w-[500px] md:mx-auto">
      <h1 className="text-center font-bold text-[20px] pt-[31px] pb-[10px]">Register Your Account</h1>

      <div className="p-2 w-1/2 mx-auto mb-5">
        <p className="text-red-500 ml-2 font-semibold text-sm md:text-base">
      ...
      <form className="flex flex-col gap-3 justify-center items-center pb-[35px] mx-5 md:mx-[50px]">
        ...
        <div className="w-full flex items-center overflow-hidden border-2 border-[#374151] rounded-xl">
          <label className="block px-2 cursor-pointer" htmlFor="name">
            <svg width="23" height="21" viewBox="0 0 23 21" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M11.2069 10.5C13.7065 10.5 15.7328 8.54125 15.7328 6.125C15.7328 3.70875 13.7065 1.75 11.2069 1.75C8.70733 1.75 6.68103 3.70875 6.68103 6.125C6.68103 8.54125 8.70733 10.5 11.2069 10.5Z" stroke="#374151" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M18.9823 19.25C18.9823 15.8637 15.4974 13.125 11.2069 13.125C6.91637 13.125 3.43146 15.8637 3.43146 19.25" stroke="#374151" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </label>
          <input type="text" className="w-full border-l-2 border-[#374151]  p-2 focus:outline-none " placeholder="Insert your name" id="name" autoComplete="off" name="name" value={values.name} onChange={handleChange} />
        </div>
        {/* Input end */}
        ...
        <div className="w-full">
          <button className="bg-[#312ECB] text-white text-center p-2 rounded-xl w-full" type="button" onClick={() => handleSubmit(values)}>Register</button>
        </div>
        {/* Submit button end */}

        {/* Have an accoubt */}
        <div className="flex gap-1 items-center  mt-[13px]">
          <h3 className="text-[15px]">Have an account?</h3>
          <Link to="/login" className="text-[12px] text-bluePrimary">Login</Link>
        </div>
      </form>
    </div>
  );
